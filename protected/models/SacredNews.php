 ...
 * @property integer $news_title
 * @property integer $news_detail
...
class SacredNews extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('news_id,news_title,news_detail,mem_id, news_updatedate, news_status', 'required'),
            array('mem_id, news_status', 'numerical', 'integerOnly' => true),
            array('news_title', 'length', 'max' => 255),
            array('news_id, news_title,news_detail, mem_id, news_updatedate, news_status', 'safe', 'on' => 'search'),
        );
    }
