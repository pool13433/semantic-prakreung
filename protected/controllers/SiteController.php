...
class SiteController extends Controller {
    ...
    public function actionIndex() {
         ...
         * Meta SEO Tag
         */
        $this->pageTitle = 'sudyodprakruang.com เว็บพระเครื่องของคนรุ่นใหม่ ซื้อ ขาย พระเครื่อง วัตถุมงคล ฯลฯ ฟรี 
        รวมข่าวสารเกี่ยวกับพระเครื่อง ใช้งานง่าย รองรับการใช้งานบนอุปกรณ์เครื่องมือสื่อสารทุกชนิด';
        /*
         * Meta SEO tag
         */
...
//exit();
         ...
         * Meta SEO Tag
         */
        $this->pageTitle = $sacredObject->obj_name . ' ดูข้อมูลรายละเอียด รูปภาพเพิ่มเติม พระเครื่องที่เกี่ยวข้อง เบอร์ติดต่อ แสดงความคิดเห็น อื่น ๆ';
        /*
         * Meta SEO tag
         */
    ...
    public function actionNewsDetail($id) {
        ...
        $this->data['news'] = $news;
        $this->data['listNewsDetail'] = SacredNewsImg::model()->findAllByAttributes(array(
                ...
                if (empty($this->member)) {
                    ...
                    if ($sacredObject->save(false)) {
                        ...
                        if (!empty($_FILES['fileOther'])) {
                            $listFileOther = $utility->readArrayFiles($_FILES['fileOther']);
